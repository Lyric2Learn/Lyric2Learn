...
const WelcomePage = ({ navigation }) => {
  ...
  return (
    <LinearGradient colors={['#E5B2CA', '#CF86DC']} style={styles.linear}>
      <Image
        source={require('../Images/Lyric2LearnLogo.png')}
        style={styles.logo}
      />
      <View style={styles.container}>
        <Image source={require('../Images/Note.png')} style={styles.note} />
        <Image
          source={require('../Images/SplashSally.png')}
          style={styles.splashSally}
        />
        <Image
          source={require('../Images/WelcomePageDrop.png')}
          style={styles.drop}
        />
      </View>
      <CustomButton
        buttonColor={'#ffffff47'}
        buttonName={letsGetStarted}
        titleColor={'#FFF'}
